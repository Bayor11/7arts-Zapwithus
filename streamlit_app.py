...
st.write("When or before all of these are taken, we can set up a designated observatory to track the value of these works and their flow from hands to hands depending on whether as a collector, you'd like your details disclosed or maintain anonymity with minimal information displayed.  \n As always, I don't doubt that all these will be collected including the SAPA (serious absence of purchasing ability) collection that is most likely to follow.")
